        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-zinc-950 to-black text-white font-sans antialiased flex flex-col lg:flex-row">
            ...
            >
                ...
                <nav className="flex-1 space-y-6 flex flex-col">
                    <a href="#courses" className="flex items-center gap-4 text-zinc-300 hover:text-amber-400 transition-all duration-300 transform hover:translate-x-1">
                        <BookOpen size={24} className="text-amber-300" /> <span className="text-lg">Courses</span>
                    </a>
                    <a href="#assignments" className="flex items-center gap-4 text-zinc-300 hover:text-amber-400 transition-all duration-300 transform hover:translate-x-1">
                        <ClipboardList size={24} className="text-teal-400" /> <span className="text-lg">Assignments</span>
                    </a>
                    <a href="#students" className="flex items-center gap-4 text-zinc-300 hover:text-amber-400 transition-all duration-300 transform hover:translate-x-1">
                        <Users size={24} className="text-blue-400" /> <span className="text-lg">Students</span>
                    </a>
                    <a href="#progress" className="flex items-center gap-4 text-zinc-300 hover:text-amber-400 transition-all duration-300 transform hover:translate-x-1">
                        <BarChart3 size={24} className="text-purple-400" /> <span className="text-lg">Progress</span>
                    </a>
                    <a href="#schedule" className="flex items-center gap-4 text-zinc-300 hover:text-amber-400 transition-all duration-300 transform hover:translate-x-1">
                        <Calendar size={24} className="text-lime-400" /> <span className="text-lg">Schedule</span>
                    </a>
                    <a href="#announcements" className="flex items-center gap-4 text-zinc-300 hover:text-amber-400 transition-all duration-300 transform hover:translate-x-1">
                        <Megaphone size={24} className="text-rose-400" /> <span className="text-lg">Announcements</span>
                    </a>
                    <a href="#resources" className="flex items-center gap-4 text-zinc-300 hover:text-amber-400 transition-all duration-300 transform hover:translate-x-1">
                        <Upload size={24} className="text-sky-400" /> <span className="text-lg">Resources</span>
                    </a>
                    <a href="#settings" className="flex items-center gap-4 text-zinc-300 hover:text-amber-400 transition-all duration-300 transform hover:translate-x-1">
